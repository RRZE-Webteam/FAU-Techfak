...
<body <?php body_class(); ?>>
	...
	<div id="wrap">
		...
		<header id="header">
		    <section id="fauorg">
		<div class="container">
				<nav aria-labelledby="bc-title" class="fauorg-breadcrumb">
				   <h4 class="screen-reader-text" id="bc-title"><?php _e('Universitäre Navigation','fau'); ?></h4>
				<a href="https://www.fau.de">Friedrich-Alexander-Universität Erlangen-Nürnberg</a>
				<span> &nbsp;/ &nbsp;</span> <a href="https://www.tf.fau.de">Technische Fakultät</a>
				<span> &nbsp;/ &nbsp;</span> <a href="https://www.informatik.tf.fau.de">Department Informatik</a>
				</nav>
			    </div>
		</section>
			<div class="container">
